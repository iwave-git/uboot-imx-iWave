...
#ifndef __IMX8MM_IWG34S_H
#define __IMX8MM_IWG34S_H
...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	...
	"disp=hdmi\0" \
	"mmcargs=setenv bootargs ${jh_clk} console=${console} root=${mmcroot} " CMD_LINE "\0 " \
...
#if defined(CONFIG_SDRAM_SIZE_4GB) || (CONFIG_SDRAM_SIZE_8GB)
...
#define CONFIG_SYS_PROMPT		"iWave-G34S > "
...
#if defined(CONFIG_TARGET_IMX8MM_IWG34S_UUU)
#include "imx8mm_iwg34s_uuu.h"
#endif
