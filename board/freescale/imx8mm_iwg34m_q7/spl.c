...
#define USDHC2_PWR_GPIO IMX_GPIO_NR(1, 1)
...
static iomux_v3_cfg_t const usdhc2_pads[] = {
	...
	IMX8MM_PAD_GPIO1_IO01_GPIO1_IO1	  | MUX_PAD_CTRL(USDHC_GPIO_PAD_CTRL),
};
...
int power_init_board(void)
{
	...
	/* increase NVCC_DRAM_1V2 to 1.1v for DDR4 */
	pmic_reg_write(p, BD718XX_4TH_NODVS_BUCK_VOLT, 0x1E);
#endif
