...
static iomux_v3_cfg_t lt8912_reset_pads[] = {
	IMX8MN_PAD_SAI2_RXD0__GPIO4_IO23 | MUX_PAD_CTRL(NO_PAD_CTRL),
};
...
#define GPIO_PAD_CFG_CTRL ( PAD_CTL_DSE1 | PAD_CTL_ODE | PAD_CTL_PUE )
...
static iomux_v3_cfg_t const board_cfg[] = {
	...
	IMX8MN_PAD_NAND_CE0_B__GPIO3_IO1 | MUX_PAD_CTRL(GPIO_PAD_CFG_CTRL),
	IMX8MN_PAD_GPIO1_IO00__GPIO1_IO0 | MUX_PAD_CTRL(GPIO_PAD_CFG_CTRL),
	IMX8MN_PAD_GPIO1_IO10__GPIO1_IO10 | MUX_PAD_CTRL(GPIO_PAD_CFG_CTRL),
	IMX8MN_PAD_GPIO1_IO11__GPIO1_IO11 | MUX_PAD_CTRL(GPIO_PAD_CFG_CTRL),
...
/* IWG37S: Print Board Information */
static void printboard_info(void)
{
	int bom_rev = 0, pcb_rev = 0;
	struct tag_serialnr serialnr;

	/*IWG37S : Adding CPU Unique ID read support*/
...
/* IWG37S: Display selection Implementation */
int ft_board_setup (void *blob, struct bd_info *bd)
{
	...
	ret = fdt_setprop_string(blob, fdt_path_offset(blob, "/soc@0/bus@32c00000/usb@32e40000"), "dr_mode", "otg");
	if (ret)
		return ret;
#endif
...
int board_late_init(void)
{
	...
	env_set("board_name", "iW-RainboW-G37S-i.MX8M Nano Pico ITX SBC");
