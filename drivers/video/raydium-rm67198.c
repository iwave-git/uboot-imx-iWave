...
static const cmd_set_table mcs_rm67198[] = {
	{0xFE, 0xD0},
	{0x40, 0x02},
	{0x4B, 0x4C},
	{0x49, 0x01},
...
static int rm67198_enable(struct udevice *dev)
{
	...
	ret = rad_panel_push_cmd_list(dsi, &mcs_rm67198[0],
		sizeof(mcs_rm67198) / CMD_TABLE_LEN);
	if (ret < 0) {
...
static const struct udevice_id rm67198_panel_ids[] = {
	{ .compatible = "raydium,rm67198", .data = (ulong)&rad_rm67198 },
	{ }
};
...
U_BOOT_DRIVER(rm67198_panel) = {
	...
	.priv_auto = sizeof(struct rm67198_panel_priv),
};
